...
python3 nyx_packer.py --nyx_net_debug_mode --purge --setup_folder ~/nyxnet/nyx-net/targets/extra_folders/echoserver_extra_folder --nyx_net --nyx_net_port 1234 ~/nyxnet/nyx-net/targets/setup_scripts/build/echoserver/echoserver /tmp/echo_packed nyxnet instrumentation
